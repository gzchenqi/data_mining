...
//        student_newMatrix.add(GetZScore(student_Matrix.get(6)));

//        for (int i = 0; i < student_Matrix.get(0).size(); i++) {
//            System.out.println(student_newMatrix.get(0).get(i));
//
//        }
...
//                System.out.println("ZScore化"+(list.get(i) - avg) / s);
            }
        }
        return ret;
    }
